			...
			<div class="col-md-6 w3-about-left">
				  <section class="slider">
					...
					<div id="carousel" class="flexslider">
					  <ul class="slides">
						<li>
							<img src="images/image1.jpg" alt="no image found" height="250px"/>
						</li>
						<li>
							<img src="images/image2.jpg" alt="no image found" height="250px"/>
						</li>
						<li>
							<img src="images/image3.jpg" alt="no image found" height="250px"/>
						</li>
						<li>
							<img src="images/image1.jpg" alt="no image found" height="250px"/>
						</li>
						<li>
							<img src="images/image2.jpg" alt="" height="250px"/>
						</li>
						<li>
							<img src="images/image3.jpg" alt="" height="250px"/>
						</li>
						<li>
							<img src="images/image5.jpg" alt="" height="250px"/>
						</li>
						<li>
							<img src="images/image3.jpg" alt="" height="250px"/>
						</li>
						<li>
							<img src="images/image1.jpg" alt="" height="250px"/>
						</li>
						<li>
							<img src="images/image2.jpg" alt="" height="250px"/>
						</li>
		...
		<div class="container">
			...
			<div class="w3_services_grids">
				...
				<div class="col-md-3 col-sm-3  col-xs-6  w3ls_team_grid">
					<div class="w3ls_team_grid1 hover15">
						<figure>
							<img src="images/Avinash.jpg" alt=" " class="img-responsive" />
						</figure>
						<div class="w3ls_team_grid1_pos">
							<ul class="social-icons">
								<li><a href="#" class="icon icon-border instagram"></a></li>
		...
		<div class="col-md-9 col-sm-12 wthree-footer-left">
			...
			<div class="list-footer">
				  <ul class="footer-nav">
					...
					<li><a class="page-scroll scroll" href="#hauntedplaces">Haunted Places</a></li>
					<li><a class="page-scroll scroll" href="#contact">Contact</a></li>
					<li><a href="login.html"><font color="white">Sign in</font></a></li>
					<li><a href="register/registration.html"><font color="white">Register</font></a></li>
				</ul>
			</div>
		</div>
